...
import { useUpsertHealthGoal } from "@/lib/queries/use-health-goal";
...
/**
 * The health-goal editor. Used both standalone (first-time setup) and inside the
 * Edit-goal modal; `onSaved` lets the modal close after a successful save.
 */
